    ...
    fun insertNewNote(
        ...
        val cacheResponse = object : CacheResponseHandler<NoteListViewState, Long>(
            ...
            override suspend fun handleSuccess(resultObj: Long): DataState<NoteListViewState> {
                // If something was inserted into cache, result will be > 0
                return if (resultObj > 0) {
                    // Prepare the success return object
                    ...
                    // Prepare the failed response object
                    DataState.data(
                        response = Response(
        ...
        // Use case step 2 - update network
