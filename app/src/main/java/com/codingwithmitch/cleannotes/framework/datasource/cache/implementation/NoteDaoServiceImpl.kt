...
import com.codingwithmitch.cleannotes.framework.datasource.cache.util.CacheMapper
...
constructor(
    ...
    override suspend fun deleteNotes(notes: List<Note>): Int {
        // get the ids of the provided notes to delete using kotlin map function
    ...
    // This is a mitch mistake (he said it in notedaoservice-implementation)
    // it is the same as searchNotes()
