...
import com.codingwithmitch.cleannotes.framework.presentation.notedetail.state.CollapsingToolbarState.Collapsed
import com.codingwithmitch.cleannotes.framework.presentation.notedetail.state.CollapsingToolbarState.Expanded
...
import com.codingwithmitch.cleannotes.framework.presentation.notedetail.state.NoteInteractionManager
...
constructor(
    ...
    override fun handleNewData(data: NoteDetailViewState) {
        // no data coming in from requests - we just submit data from this screen,
        // we don't receive
    }
